...
use function StudentAssignmentScheduler\Querying\Functions\importJson;
use function StudentAssignmentScheduler\FileNaming\Functions\{
    jsonAssignmentFilename,
    jsonAssignmentCopyFilename
};
use function StudentAssignmentScheduler\Utils\Functions\dayOfMonthFromAssignmentDate;
...
class CopyAndSwapJsonAssignmentTest extends TestCase
{
    ...
    protected function setup(): void
    {
        ...
        $this->path_to_copy = jsonAssignmentCopyFilename(
            new Destination($path_to_mock_assignments),
            $date_time,
